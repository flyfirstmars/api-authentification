...
function SignUp() {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            navigate('/confirmation', {state: {message: 'Successfully signed up!'}});
        } catch (error) {
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label htmlFor="birthdate" className="block text-sm font-medium text-gray-700">
                                <FaBirthdayCake className="mr-2 inline"/>Birth Date
                            </label>
                            <div className="mt-1">
                                <input
                                    id="birthdate"
                        ...
                        <div>
                            <label htmlFor="contactAddress" className="block text-sm font-medium text-gray-700">
                                <FaHome className="inline-block mr-2"/> Contact Address
                            </label>
                            <div className="mt-1">
                                <input
                                    id="contactAddress"
